...
> 最后更新：2026-07-18 | 设置页重构 | 云服务器别名 | 状态大盘优化 | 新签名密钥
...
**v4.5 更新**：
- 云服务器管理：别名系统、连接状态显示、四端统一格式兼容
- 设置页全面重构：卡片拆分+折叠箭头+动态副标题+间距优化
- 状态大盘优化：策略标签、连接状态整合、失败原因提示
- 新签名密钥防止华为误报，新仓库 github.com/ztj555/autodial
- 默认云服务器：101.34.65.254:35430
...
| 35432 | HTTP + WebSocket | PC 端主服务（局域网直连 + 浏览器扩展连接） |

> 默认云服务器：101.34.65.254:35430（可在 App/插件端修改）
...
使用 Android Studio 打开 `android-app/` 目录构建，或下载 GitHub Actions 自动构建的 APK。
