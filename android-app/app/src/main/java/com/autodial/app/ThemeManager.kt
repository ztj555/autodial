...
object ThemeManager {
    ...
    private fun buildThemes(): List<ThemeInfo> = listOf(
        ...
        // 8. 森林绿
        // v5.5: defaultMode 由 dark 改 light —— 原深色档 bg #0E1810 近乎纯黑，
        // 弹窗/PC 端观感发闷（用户反馈"太阴间"）。深色档保留可选，默认给清爽浅色。
        ti("forest-green","森林绿","Forest Green","comfort",listOf("自然","安静","护眼"),"light",
            ...
            c("light","#4CAF50","#66BB6A","#43A047","#F0F8F0","#FFFFFF","#E8F4E8","#1E3A1E","#5E8A5E","#2FA75F","#E53935")
        ),
        // 9. 赛博朋克
